...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        last_size = int(math.ceil(frame_size / 32))
...
def resnet50(opt=None, weight_dir=None):
    """Constructs a ResNet-50 model.
    """
    model = ResNet(Bottleneck, [3, 4, 6, 3], num_classes=opt.action_classes, shortcut_type=opt.resnet_shortcut,
                   frame_size=opt.action_frame_size, sample_duration=opt.sample_duration)
...
def resnet101(opt=None, weight_dir=None):
    """Constructs a ResNet-101 model.
    """
    model = ResNet(Bottleneck, [3, 4, 23, 3], num_classes=opt.action_classes, shortcut_type=opt.resnet_shortcut,
                   frame_size=opt.action_frame_size, sample_duration=opt.sample_duration)
...
def resnext101(opt=None, weight_dir=None):
    """Constructs a ResNet-101 model.
    """
    model = ResNeXt(ResNeXtBottleneck, [3, 4, 23, 3], num_classes=opt.action_classes, shortcut_type=opt.resnet_shortcut,
                    frame_size=opt.action_frame_size, sample_duration=opt.sample_duration)
...
def I3D(opt=None, weight_dir=None):
    """Constructs a I3D model.
    """
...
def Action_Detector(opt=None):
    if opt.action_base_model == 'resnet50':
        ...
        model = resnet50(opt, weight_dir)
    elif opt.action_base_model == 'resnet101':
        weight_dir = '../weights/resnet-101-kinetics.pth'
        model = resnet101(opt, weight_dir)
    elif opt.action_base_model == 'resnext101':
        weight_dir = '../weights/resnext-101-kinetics.pth'
        model = resnext101(opt, weight_dir)
