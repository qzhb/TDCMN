...
def parse_opts():
    ...
    parser.add_argument(
        ...
        default='I3D',
        type=str,
        help='concept detector base model (I3D)')
    parser.add_argument(
        '--resnet_shortcut',
        default='B',
        type=str,
    ...
    parser.add_argument(
        ...
        default=1,
        type=int,
        help='Crop number of each video frame when test')
    parser.add_argument(
        '--reshape_size', default=256, type=int, help='Action model input frame size')
    parser.add_argument(
        '--frame_size', default=224, type=int, help='Action model input frame size')
    parser.add_argument(
        '--initial_scale',
        default=1.0,
        type=float,
